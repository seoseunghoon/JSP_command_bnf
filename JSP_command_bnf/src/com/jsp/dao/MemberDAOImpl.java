...
public class MemberDAOImpl implements MemberDAO {
	...
	@Override
	public String selectDepartById(SqlSession session, String writer) {
		String depart = session.selectOne("Member-Mapper.selectDepartById", writer);
		
		return depart;
	}

	@Override
	public void changeAuthority(SqlSession session, String id, String authority) throws SQLException {
		MemberVO member = new MemberVO();
		member.setId(id);
		member.setAuthority(authority);
		session.update("Member-Mapper.changeAuthority", member);
