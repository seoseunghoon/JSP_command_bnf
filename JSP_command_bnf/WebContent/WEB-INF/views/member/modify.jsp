...
<title>나눔장터 - 11월 굿바이 나눔장터 개장 안내 : 부산민원120</title>
		<link rel="stylesheet" href="/humanframe/global/assets/vendor/jquery-ui/jquery-ui.min.css">
<link rel="stylesheet" href="/humanframe/global/assets/css/global.css">
<link rel="stylesheet" href="/humanframe/theme/minwon/assets/css/common.css">

<link rel="stylesheet" href="/humanframe/theme/minwon/assets/css/content.css">
		...
		<div class="header-inner">
			<div class="header-logo">
				<div class="header-logo-area">
					<a href="http://www.busan.go.kr/index"><img src="/humanframe/theme/minwon/assets/img/common/logo_busan.png" alt="부산광역시"></a>
					<a href="/minwon"><img src="/humanframe/theme/minwon/assets/img/common/logo_minwon.png" alt="부산민원120"></a>
				</div>
			</div>
			...
			<div class="header-util">
				<ul class="header-util-area">
					<li><a href="https://www.busan.go.kr/member/register-step01">회원가입</a></li>
						<li><a href="https://www.busan.go.kr/member/login?referUrl=https://www.busan.go.kr/minwon/nanum">로그인</a></li>
...
<div class="containerInnr">
		...
		<div class="boardView">
			...
			<div class="form-group">
				<input type="text" id="title" value="${board.title }" style ="font-size:30px;"
									name='title' class="form-control" >
				<input type="hidden" name="pno" value="${board.bno }" />
			</div>
			...
			<div class="form-group">
				<dl class="form-data-content" style="text-align:center;">
					<!-- 내용 -->
					<dt><span>내용</span></dt>
					<dd>
						<textarea rows="10" id="content" name="content" style="width:95%; height: 95%; display:inline-block;">${ board.content }</textarea>
						<br>
	...
	<div id="inputPassword" style="display: none;">
		<form id="bbsPasswordChkFrm" method="post">
			<div>
				...
				<input type="hidden" name="bbsNo" id="bbsNo1" value="31"/>
				<input type="hidden" name="nttNo" id="nttNo1" value="1545045"/>
