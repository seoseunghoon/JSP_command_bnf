...
<div class="containerInnr">
		...
		<div class="btnArea btnRt">
			<!-- 수정버튼 -->
			<a href="<%= request.getContextPath() %>/market/board/modifyForm.do?bno=${board.bno}" class="btnTypeM btnLineType1" title="수정">수정</a>
			<!-- 삭제버튼 -->
			<a href="<%= request.getContextPath() %>/market/board/remove.do?bno=${board.bno}" class="btnTypeM btnLineType1" title="목록">삭제</a>
			<!-- 목록 -->
		...
		<div class="boardView">
			<div class="form-group">
				<h4 class="form-data-subject">${member.id }</h4>
			</div>
