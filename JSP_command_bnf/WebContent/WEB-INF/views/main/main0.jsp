		...
		<div class="header-inner">	
			<div class="header-logo">
				<div class="header-logo-area">
					<a href="#"><img src="<%=request.getContextPath() %>/image/logo_busan.png" alt="부산광역시"></a>
					<a href="#"><img src="<%=request.getContextPath() %>/image/logo_minwon.png" alt="부산민원120"></a>
				</div>
			</div>
...
<title>Home : 부산민원120</title>
	...
	<section class="main-visual">
		<div class="main-visual-inner">
			<div class="main-visual-slogan">
				<img src="<%=request.getContextPath() %>/image/txt_slogan.png" alt="부산시 온라인 민원제안은 부산민원120으로 통합니다"/>
			</div>
	...
	<div class="banner">
				...
				<div class="banner-img">
						<img src="/comm/getImage?srvcId=BANNER&amp;upperNo=4342&amp;fileTy=PCIMG&amp;fileNo=1" alt="여권접수 온라인 사전예약제" />
					</div>
		...
		<div class="banner">
				...
				<div class="banner-img">
						<img src="/comm/getImage?srvcId=BANNER&amp;upperNo=4308&amp;fileTy=PCIMG&amp;fileNo=2" alt="차세대 전자여권
...
※ 출처 : 외교부" />
		...
		<div class="banner">
				...
				<div class="banner-img">
						<img src="/comm/getImage?srvcId=BANNER&amp;upperNo=3363&amp;fileTy=PCIMG&amp;fileNo=2" alt="코로나19 극복을 위한 비대면 민원서비스는 사회적 거리두기 실천입니다." />
					</div>
					<div class="banner-txt">
						[카드뉴스] 비대면 민원서비스</div>
				</a>
		...
		<div class="banner">
				...
				<div class="banner-img">
						<img src="/comm/getImage?srvcId=BANNER&amp;upperNo=3365&amp;fileTy=PCIMG&amp;fileNo=2" alt="민원처리 지연보상 안내
1일 이상 유기한 민원사무 대상" />
					</div>
					<div class="banner-txt">
						민원처리 지연보상 안내</div>
		...
		<div class="banner">
				...
				<div class="banner-img">
						<img src="/comm/getImage?srvcId=BANNER&amp;upperNo=3367&amp;fileTy=PCIMG&amp;fileNo=3" alt="아직도 모르시나요? 인감증명서와 동일한 본인서명사실확인서!
1 인감증명서와 효력이 동일
2 전국 어디서나 편리한 발급
3 인감사고 사전예방
4 전자본인서명 확인서 발급
행전안전부" />
		...
		<div class="banner">
				...
				<div class="banner-img">
						<img src="/comm/getImage?srvcId=BANNER&amp;upperNo=3364&amp;fileTy=PCIMG&amp;fileNo=4" alt="국민과 가장 가까운 곳에 민원 공무원이 있습니다.
민원공무원의 안전과 인권을 적극 보호하겠습니다." />
		...
		<div class="banner">
				...
				<div class="banner-img">
						<img src="/comm/getImage?srvcId=BANNER&amp;upperNo=4309&amp;fileTy=PCIMG&amp;fileNo=1" alt="여권재발급
온라인으로 신청하세요!
※ 출처 : 외교부" />
					</div>
					<div class="banner-txt">
		...
		<div class="banner">
				...
				<div class="banner-img">
						<img src="/comm/getImage?srvcId=BANNER&amp;upperNo=3366&amp;fileTy=PCIMG&amp;fileNo=5" alt="120콜센터
						...
						<ul class="main-content-minwon-list">
							<li>
								<a href="/minwon/myminwon">
									<div class="img"><img src="<%=request.getContextPath() %>/image/ico_minwon_01.png" alt=""></div>
									<div class="tit">민원신청</div>
								</a>
							</li>
							<li>
								<a href="/minwon/myminwon/list">
									<div class="img"><img src="<%=request.getContextPath() %>/image/ico_minwon_02.png" alt=""></div>
									<div class="tit">나의 민원</div>
								</a>
							</li>
							<li>
								<a href="/minwon/manual">
									<div class="img"><img src="<%=request.getContextPath() %>/image/ico_minwon_03.png" alt=""></div>
									<div class="tit">민원편람</div>
								</a>
							</li>
							<li>
								<a href="/minwon/traffic2">
									<div class="img"><img src="<%=request.getContextPath() %>/image/ico_minwon_04.png" alt=""></div>
									<div class="tit">교통불편 민원신청</div>
								</a>
							</li>
							<li>
								<a href="/minwon/monthlyminwon">
									<div class="img"><img src="<%=request.getContextPath() %>/image/ico_minwon_05.png" alt=""></div>
									<div class="tit">이달의 주요민원</div>
								</a>
							</li>
							<li>
								<a href="https://www.busan.go.kr/bshotline/index" title="새창열림" target="_blank" rel="noreferrer noopener">
									<div class="img"><img src="<%=request.getContextPath() %>/image/ico_minwon_06.png" alt=""></div>
			...
			<ul class="main-link-list">
				<li>
					<a href="/minwon/standbycount">
						<div class="img"><img src="<%=request.getContextPath() %>/image/ico_link_01.png" alt=""></div>
						<div class="txt">여권민원 대기현황</div>
					</a>
				</li>
				<li>
					<a href="/minwon/tmpassport023" title="새창열림" target="_blank" rel="noreferrer noopener">
						<div class="img"><img src="<%=request.getContextPath() %>/image/ico_link_08.png" alt=""></div>
						<div class="txt">여권온라인서비스</div>
					</a>
				</li>
				<li>
					<a href="/minwon/tmpassport01?tabNum=17">
						<div class="img"><img src="<%=request.getContextPath() %>/image/ico_link_09.png" alt=""></div>
						<div class="txt">여권접수 온라인<br>사전예약제</div>
					</a>
				</li>
				<li>
					<a href="https://www.safetyreport.go.kr/" title="새창열림" target="_blank" rel="noreferrer noopener">
						<div class="img"><img src="<%=request.getContextPath() %>/image/ico_link_03.png" alt=""></div>
						<div class="txt">안전신문고</div>
					</a>
				</li>
<li>
					<a href="/minwon/environment">
						<div class="img"><img src="<%=request.getContextPath() %>/image/ico_link_05.png" alt=""></div>
						<div class="txt">환경신문고</div>
					</a>
				</li>
				<li>
					<a href="/yesan">
						<div class="img"><img src="<%=request.getContextPath() %>/image/ico_link_06.png" alt=""></div>
