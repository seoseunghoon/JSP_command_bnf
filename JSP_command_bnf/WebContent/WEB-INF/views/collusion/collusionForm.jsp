	...
	<tbody>
				...
				<!-- 순번 -->
						...
						<!-- 작성자 -->
							<td class="pc_Y ta_Y mo_N">
								오**</td>
						<!-- 작성일 -->
							<td class="pc_Y ta_Y mo_Y nowrap">2022-03-25</td>
						<!-- 나머지 -->
							<td class="pc_Y ta_Y mo_N">2</td>
						</tr>
		<tr>
				<!-- 순번 -->
							<td class="pc_Y ta_Y mo_N">
						...
						<!-- 제목 -->
							<td class="pc_Y ta_Y mo_Y title">
								<a href="#" onclick="f_showPasswordDialog('/minwon/gujeideaoffer02/1522198', '721', '1522198'); return false;">
											휴대용 재떨이의 적극적인 활용! 담배 꽁초 하나 없는 깨끗한 부산시!</a>
							</td>
						<!-- 첨부파일 -->
							<td class="pc_Y ta_Y mo_N">
							<img src="/humanframe/global/assets/img/ico_download_ai.png" alt="첨부파일" />
						...
						<!-- 작성자 -->
							<td class="pc_Y ta_Y mo_N">
								이**</td>
						<!-- 작성일 -->
							<td class="pc_Y ta_Y mo_Y nowrap">2022-03-18</td>
						<!-- 나머지 -->
		...
		<tr>
				<!-- 순번 -->
						...
						<!-- 제목 -->
							<td class="pc_Y ta_Y mo_Y title">
								<a href="#" onclick="f_showPasswordDialog('/minwon/gujeideaoffer02/1519847', '721', '1519847'); return false;">
											늘어나는 교통량에 따른 도로 혼잡 방지 대책 제안</a>
							</td>
						<!-- 첨부파일 -->
							<td class="pc_Y ta_Y mo_N">
							<img src="/humanframe/global/assets/img/ico_download_ai.png" alt="첨부파일" />
						...
						<!-- 작성자 -->
							<td class="pc_Y ta_Y mo_N">
								백**</td>
						<!-- 작성일 -->
							<td class="pc_Y ta_Y mo_Y nowrap">2022-02-16</td>
						<!-- 나머지 -->
							<td class="pc_Y ta_Y mo_N">0</td>
						</tr>
		<tr>
				<!-- 순번 -->
						...
						<!-- 제목 -->
							<td class="pc_Y ta_Y mo_Y title">
								<a href="#" onclick="f_showPasswordDialog('/minwon/gujeideaoffer02/1483867', '721', '1483867'); return false;">
											생계급여 수급자 노인일자리 참여 가능</a>
							</td>
						<!-- 첨부파일 -->
							<td class="pc_Y ta_Y mo_N">
							<img src="/humanframe/global/assets/img/ico_download_ai.png" alt="첨부파일" />
						...
						<!-- 작성자 -->
							<td class="pc_Y ta_Y mo_N">
								김**</td>
						<!-- 작성일 -->
							<td class="pc_Y ta_Y mo_Y nowrap">2021-04-07</td>
						<!-- 나머지 -->
							<td class="pc_Y ta_Y mo_N">1</td>
						</tr>
		<tr>
				<!-- 순번 -->
							<td class="pc_Y ta_Y mo_N">
						...
						<!-- 제목 -->
							<td class="pc_Y ta_Y mo_Y title">
								<a href="#" onclick="f_showPasswordDialog('/minwon/gujeideaoffer02/1482407', '721', '1482407'); return false;">
											플라스틱 재활용</a>
							</td>
						<!-- 첨부파일 -->
							<td class="pc_Y ta_Y mo_N">
						...
						<!-- 작성자 -->
							<td class="pc_Y ta_Y mo_N">
								이**</td>
						<!-- 작성일 -->
							<td class="pc_Y ta_Y mo_Y nowrap">2021-03-31</td>
						<!-- 나머지 -->
							<td class="pc_Y ta_Y mo_N">1</td>
						</tr>
		<tr>
				<!-- 순번 -->
						...
						<!-- 제목 -->
							<td class="pc_Y ta_Y mo_Y title">
								<a href="#" onclick="f_showPasswordDialog('/minwon/gujeideaoffer02/1479378', '721', '1479378'); return false;">
											고객만족도 조사 개선</a>
							</td>
						<!-- 첨부파일 -->
							<td class="pc_Y ta_Y mo_N">
						...
						<!-- 작성자 -->
							<td class="pc_Y ta_Y mo_N">
								양**</td>
						<!-- 작성일 -->
							<td class="pc_Y ta_Y mo_Y nowrap">2021-03-18</td>
						<!-- 나머지 -->
							<td class="pc_Y ta_Y mo_N">0</td>
						</tr>
		<tr>
				<!-- 순번 -->
						...
						<!-- 제목 -->
							<td class="pc_Y ta_Y mo_Y title">
								<a href="#" onclick="f_showPasswordDialog('/minwon/gujeideaoffer02/1478438', '721', '1478438'); return false;">
											제로페이 활성화 개선 방안</a>
							</td>
						<!-- 첨부파일 -->
							<td class="pc_Y ta_Y mo_N">
						...
						<!-- 작성자 -->
							<td class="pc_Y ta_Y mo_N">
								손**</td>
						<!-- 작성일 -->
							<td class="pc_Y ta_Y mo_Y nowrap">2021-03-09</td>
						<!-- 나머지 -->
							<td class="pc_Y ta_Y mo_N">3</td>
						</tr>
		<tr>
				<!-- 순번 -->
							<td class="pc_Y ta_Y mo_N">
						...
						<!-- 제목 -->
							<td class="pc_Y ta_Y mo_Y title">
								<a href="#" onclick="f_showPasswordDialog('/minwon/gujeideaoffer02/1477690', '721', '1477690'); return false;">
											환불</a>
							</td>
						<!-- 첨부파일 -->
							<td class="pc_Y ta_Y mo_N">
						...
						<!-- 작성자 -->
							<td class="pc_Y ta_Y mo_N">
								차**</td>
						<!-- 작성일 -->
							<td class="pc_Y ta_Y mo_Y nowrap">2021-03-02</td>
						<!-- 나머지 -->
							<td class="pc_Y ta_Y mo_N">1</td>
						</tr>
		<tr>
				<!-- 순번 -->
						...
						<!-- 제목 -->
							<td class="pc_Y ta_Y mo_Y title">
								<a href="#" onclick="f_showPasswordDialog('/minwon/gujeideaoffer02/1472265', '721', '1472265'); return false;">
											효율적인 도심철도 환승 LINE 제안(수영강 트램 설치)</a>
							</td>
						<!-- 첨부파일 -->
							<td class="pc_Y ta_Y mo_N">
							<img src="/humanframe/global/assets/img/ico_download_ai.png" alt="첨부파일" />
						...
						<!-- 작성자 -->
							<td class="pc_Y ta_Y mo_N">
								이**</td>
						<!-- 작성일 -->
							<td class="pc_Y ta_Y mo_Y nowrap">2021-01-04</td>
						<!-- 나머지 -->
							<td class="pc_Y ta_Y mo_N">0</td>
						</tr>
		</tbody>
...
<script type="text/javascript">
	...
	if(current_url.indexOf('news.busan.go.kr') > -1){
		if(current_url.indexOf('dataNo') > -1){
			refer = "https://www.busan.go.kr/gujeideaoffer02/view?dataNo=";
		}else if("3" == "3"){
			refer = "https://www.busan.go.kr/gujeideaoffer02/";
		}else{
			refer = "https://www.busan.go.kr/gujeideaoffer02";
		}
	}else{
