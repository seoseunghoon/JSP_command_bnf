...
<div class="containerInnr">
		...
		<div class="boardView">
			...
			<form enctype="multipart/form-data" role="form" method="get" action="modify.do" name="modifyForm">
			<div class="form-group">
				<input type="text" style="width:100%;font-size:25px;"id="title" value="${board.title }" name='title' class="form-control" >
