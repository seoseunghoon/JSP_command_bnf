...
//              }
   ...
   <div id="contents">
      ...
      <form encType="multipart/form-data" id="frmNtt" name="frmNtt" action="<%=request.getContextPath() %>/board/report/regist.do" method="post">
     <!--  <input id="crud" name="crud" type="hidden" value="CREATE"/>
         ...
         <tbody>
            ...
            <!-- 제목 -->
               <tr>
                  ...
                  <td><input id="sj" name="title" class="textForm" style="width:100%;" title="제목" type="text" value="${reportBoard.title }"/></td>
               </tr>
            <!-- 작성자 -->
            <tr>
               <th scope="row"><label for="wrter">작성자</label><span class="nbTxtTbRequired">*<span class="hidden" >필수입력사항</span></span></th>
               <td>
                  <input id="wrter" name="writer" class="textForm" style="width:31%;min-width:110px;"  title="작성자" type="text" value="${reportBoard.writer }"/></td>
            </tr>
            <!-- 공개여부 -->
               <tr>
               </tr>
      ...
      <div class="btnArea">
         <span class="fC">
                <button type="submit" class="btnTypeM btnLineType1" value="">수정</button>
